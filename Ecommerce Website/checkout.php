...
if(isset($_POST['order'])){
   ...
   if($check_cart->rowCount() > 0){
      ...
      header('location:success/order_successful.php');
...
<section class="checkout-orders">
   ...
   <h3>your orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>city :</span>
            <input type="text" name="city" placeholder="e.g. Port Louis" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>country :</span>
            <input type="text" name="country" placeholder="e.g. Mauritius" class="box" maxlength="50" required>
         </div>
